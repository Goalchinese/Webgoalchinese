    ...
    <v-row dense>
      <v-col cols="12">
        <v-data-table
          ...
          :options.sync="paginationTeachers"
          mobile-breakpoint="0"
          show-select
...
export default {
  ...
  watch: {
    search() {
      ...
      this.paginationTeachers.page = 1;
  ...
  methods: {
    async fetchDataTeacher() {
      ...
      try {
        ...
        const limit =
          this.paginationTeachers.itemsPerPage === -1
            ? 1000
            : this.paginationTeachers.itemsPerPage;
        const params = {
          role: "teacher",
    ...
    updatePaginationTeachers(options) {
      this.paginationTeachers.page = options.page;
      this.paginationTeachers.itemsPerPage = options.itemsPerPage;
