<template>
  <v-row class="mb-4">
    <v-col cols="12">
      <div class="text-h4 font-weight-bold">Student Library Materials</div>
      <p class="text-body-small text-medium-emphasis mb-0">
        Manage students and library materials.
      </p>
    </v-col>
  </v-row>
    ...
    >
      ...
      <template #item.name="{ item }">
        <div class="d-flex align-center pa-1">
          ...
          <span
            class="font-weight-medium ms-3 text-truncate text-primary-darken-4"
            >{{ item.name }}</span
          >
        </div>
      </template>
  ...
  <v-card rounded="lg" elevation="1" class="pa-4">
    <v-row align="center">
      ...
      <v-col cols="12" md="3" class="ml-md-auto">
        <AppTextField
